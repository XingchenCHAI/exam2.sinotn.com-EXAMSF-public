...
r=function(){dpi=window.devicePixelRatio;$('.js-57').attr('src', (dpi>1) ? 'images/wechatimg80-16.png' : 'images/wechatimg80-8.png');
$('.js-58').attr('src', (dpi>1) ? 'images/wechatimg80-16.png' : 'images/wechatimg80-8.png');
$('.js-59').attr('src', (dpi>1) ? 'images/wechatimg80-16.png' : 'images/wechatimg80-8.png');
$('.js-60').attr('src', (dpi>1) ? 'images/wechatimg80-16.png' : 'images/wechatimg80-8.png');
...
$('.js-65').attr('src', (dpi>1) ? 'images/wechatimg101-1512.jpeg' : 'images/wechatimg101-756.jpeg');};
